    ...
    describe("Auth", () => {
        describe("Signup", () => {
            it("should sing up", async () => {
                ...
                return pactum.spec().post("http://localhost:8000/auth/signup").withBody(dto).expectStatus(201);
            });
        });
        describe("Signin", () => {
            it("should sing in", () => {
                ...
                return pactum.spec().post("http://localhost:8000/auth/signin").withBody(dto).expectStatus(200).stores("token", "access_token");
            });
        });
    });
